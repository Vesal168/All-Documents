...
x_test_reshaped = np.reshape(X_test, (165, total_frames, keypoints * 2))
...
# Train the model
history = model.fit(x_train_reshaped, y_train, epochs=1000, batch_size=10, shuffle=True, validation_data=(x_test_reshaped, y_test))
