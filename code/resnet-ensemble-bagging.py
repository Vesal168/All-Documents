...
bagging_svm.fit(train_features_pca, y_train)
bagging_knn.fit(train_features_pca, y_train)
bagging_rf.fit(train_features_pca, y_train)

# Evaluate Bagging classifiers
bagging_classifiers = {'Bagging SVM': bagging_svm, 'Bagging KNN': bagging_knn, 'Bagging RF': bagging_rf}
...
# Create a dictionary of bagging classifiers
classifiers = [
