...
# Reshape data for ResNet Architecture
...
# Building the fine-tuning ResNet block

def resnet_block(inputs, filters, kernel_size, strides):
    
    # Con2D with padding same
    ...
    # Applied shortcut and action function ReLU 
...
# Create fine-tuning ResNet model
# Three ResNet Blocks created
...
# Model compile with sparse categorical crossentropy
...
# Track starting time for training the model

start_time = time.time()

# Fit model with epoch 300 batch-size 4
...
# Track ending time for training the model
...
# Create Extract features based on Model trained after trained
...
# Determine the number of components for PCA before apply ML models classification
